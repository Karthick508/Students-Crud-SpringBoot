package com.example.Angler.core.responseDo;
...
public class ResponseDo {
	...
	public ResponseDo setSuccessResponseMessageWithData(Object data,String message) {
	...
	public ResponseDo setFailureResponse(String message,Object data ) {
		ResponseDo res = new ResponseDo();
		res.setStatus(0);
		res.setData(data);
		res.setMessage(message);
